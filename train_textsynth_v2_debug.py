...
from dataset import hierarchical_dataset, AlignPairCollate, AlignPairImgCollate, AlignSynthTextCollate, Batch_Balanced_Dataset, tensor2im, save_image, phoc_gen, text_gen, text_gen_synth, LmdbStyleDataset, LmdbStyleContentDataset, AlignPairImgCollateVarSize
...
def train(opt):
    ...
    AlignCollate_validVarSize = AlignPairImgCollateVarSize(imgH=opt.imgH, imgW=opt.imgW, keep_ratio_with_pad=opt.PAD)
    ...
    valid_loader = torch.utils.data.DataLoader(
        ...
        num_workers=int(opt.workers),
        collate_fn=AlignCollate_validVarSize, pin_memory=True, drop_last=True)
