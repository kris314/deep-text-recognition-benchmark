...
def train(opt):
    ...
    while(True):
        ...
        if g_regularize:
            ...
            fake_img, grad = genModel(style, z_c_code, return_latents=True, g_path_regularize=True, mean_path_length=mean_path_length)
        ...
        if (iteration + 1) % opt.valInterval == 0 or iteration == 0: # To see training progress, we also conduct validation when 'iteration == 0' 
            ...
            fake_img_c1_s1, _ = g_ema(style_s1, z_c_code_1, input_is_latent=opt.input_latent)
            fake_img_c2_s1, _ = g_ema(style_s1, z_c_code_2, input_is_latent=opt.input_latent)
            fake_img_c1_s2, _ = g_ema(style_s2, z_c_code_1, input_is_latent=opt.input_latent)
