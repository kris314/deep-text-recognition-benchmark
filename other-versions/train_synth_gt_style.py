...
from model import StyleTensorEncoder, MsImageDisV2, AdaIN_Tensor_WordGenerator, VGGPerceptualLossModel
from test_synth import validation_synth_v3
            ...
            with open(os.path.join(opt.exp_dir,opt.exp_name,'log_train.txt'), 'a') as log:
                ...
                with torch.no_grad():                    
                    valid_loss, infer_time, length_of_data = validation_synth_v3(
                        iteration, styleModel, genModel, vggModel, disModel, recCriterion, valid_loader, converter, opt)
