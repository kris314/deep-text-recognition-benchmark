...
from test_synth import validation_synth_v2
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_dir', default='/checkpoint/pkrishnan/experiments/scribe/Exp09/', help='Where to store logs and models')
