...
infolder_ours = '/checkpoint/pkrishnan/experiments/scribe/Exp18/userstudy/icdar15_all_13_690001/testImages/690001/'
...
# ICDAR15
outFolder_real='/checkpoint/pkrishnan/experiments/scribe/Exp18/userstudy/subset-112/icdar15_real/'
outFolder_ours='/checkpoint/pkrishnan/experiments/scribe/Exp18/userstudy/subset-112/icdar15_ours/'
...
for i in idx:
    ...
    if os.path.exists(os.path.join(infolder_ours,infile_ours)) and os.path.exists(os.path.join(infolder_srnet,labelFile)):
